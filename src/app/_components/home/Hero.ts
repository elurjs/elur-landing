...
<section class="home-hero">
    ...
    <div class="home-hero-content">
      <div class="home-hero-badge">
        <span class="dot"></span>
        v4.0.5 — New reactive engine: glitch-free diamonds, lazy computeds, real ownership
      </div>
      <a href="/docs/ecosystem/kit/overview/"
        ...
        Elur Kit 2.6.1 — Full-stack meta-framework →
      </a>
      <h1>
      ...
      <p class="home-hero-subtitle">
        A lightweight reactive framework with fine-grained signals and zero dependencies. No virtual DOM, no compiler
        required — one runtime for web, mobile, and full-stack.
      </p>
      <div class="home-hero-actions">
        <a href="/docs/getting-started/introduction/" class="home-btn-primary">
          Get Started
        ...
        <a href="https://github.com/elurjs/elur" class="home-btn-secondary" target="_blank" rel="noopener">
      ...
      <div class="home-ecosystem-bar">
        <span class="home-eco-badge"><span class="home-eco-dot ts"></span> TypeScript-first</span>
        <span class="home-eco-badge"><span class="home-eco-dot mit"></span> MIT License</span>
        <span class="home-eco-badge"><span class="home-eco-dot test"></span> 1900+ tests passing</span>
        <span class="home-eco-badge"><span class="home-eco-dot"
            style="background:#10b981;box-shadow:0 0 10px rgba(16, 185, 129,0.5)"></span> 92.9% Coverage</span>
        <span class="home-eco-badge"><span class="home-eco-dot size"></span> ~21 KB gzipped</span>
        <span class="home-eco-badge"><span class="home-eco-dot" style="background:#60a5fa"></span> Elur UI</span>
        <span class="home-eco-badge"><span class="home-eco-dot" style="background:#fb923c"></span> Elur Query 1.6.2</span>
        <span class="home-eco-badge"><span class="home-eco-dot" style="background:#f472b6"></span> Elur Auth 1.3.2</span>
        <span class="home-eco-badge"><span class="home-eco-dot" style="background:#3432c8"></span> Elur Kit 2.6.1</span>
