...
<section class="home-section" id="features">
    <div class="home-container">
      <div class="home-section-header animate-on-scroll">
        <div class="home-section-label">⚡ Why Elur</div>
        <h2 class="home-section-title">Everything you need,<br>nothing you don't.</h2>
