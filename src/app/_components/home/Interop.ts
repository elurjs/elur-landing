...
export function Interop(): ElurTemplate {
  return raw(`
<section class="home-section home-interop-section" id="interop">
    <div class="home-container">
      <div class="home-section-header animate-on-scroll">
        <div class="home-section-label">🔌 JavaScript Interop</div>
        <h2 class="home-section-title">Use DOM-first libraries<br><span class="home-gradient-text">without wrappers.</span></h2>
        <p class="home-section-desc">Real integration pattern: use refs, lifecycle hooks, and cleanup exactly as you would
          in production code.</p>
      </div>

      <div class="home-interop-grid">
        <div class="home-interop-text animate-on-scroll">
          ...
          <div class="home-interop-libs">
            <div class="home-interop-lib">
        ...
        <div class="home-interop-code animate-on-scroll">
